...
export function TrendChart({ data }: TrendChartProps) {
  ...
  return (
    <div className="flex flex-col gap-6">
      <section>
        <h3 className="text-sm font-medium text-ink-secondary">Mention volume</h3>
      ...
      <section>
        <h3 className="text-sm font-medium text-ink-secondary">Sentiment</h3>
        <div className="h-32 w-full">
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={data}>
              <defs>
      ...
      <section>
        <h3 className="text-sm font-medium text-ink-secondary">Signal Score</h3>
        <div className="h-32 w-full">
          <ResponsiveContainer width="100%" height="100%">
            <LineChart data={data}>
              <CartesianGrid vertical={false} stroke={CHART_CHROME.gridline} />
